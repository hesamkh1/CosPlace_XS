...
def parse_arguments(is_training: bool = True):
    ...
    parser.add_argument("--contrast", type=float, default=0.3, help="_")
    ...
    parser.add_argument("--rotation_degrees", type=int, default=10,help="Degrees for random rotation augmentation")
    parser.add_argument("--cutout_size", type=int, default=16,help="Size for cutout augmentation")
