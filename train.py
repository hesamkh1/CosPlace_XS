...
if args.augmentation_device == "cuda":
    gpu_augmentation = T.Compose([
        augmentations.DeviceAgnosticColorJitter(brightness=args.brightness,
                                                ...
                                                hue=args.hue),
        augmentations.DeviceAgnosticRandomResizedCrop(size=(512, 512),
                                                      scale=(1-args.random_resized_crop, 1)),
        augmentations.DeviceAgnosticRandomRotation(degrees=(-args.rotation_degrees, args.rotation_degrees)),
        augmentations.DeviceAgnosticCutout(size=args.cutout_size, p=0.5, constant_fill=0),
